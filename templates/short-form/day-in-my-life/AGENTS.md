...
**Porting an existing composition?** No longer applicable — the legacy React composition pipeline was removed; everything is authored natively as HyperFrames HTML.
